...
{
    /// <summary>
    /// SceneWriting differs from prefab writing in that it is intended to output something sane for large-scale use
    ///     PrefabWriter is for a compact "who cares" object, while this is for an entire scene that needs to render sanely
    /// </summary>
